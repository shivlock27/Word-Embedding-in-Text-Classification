...
sample = open("C:/Users/Shivang/Desktop/Twitter airline/dataset.csv", "r",encoding="utf8") 
s = sample.read() 
f = s.replace("\n", " ") 
...
fname='C:/Users/Shivang/Desktop/Twitter airline/cbow_dataset.csv'
np.savetxt(fname,X_comtdata_average1, delimiter=',', fmt='%f')
X_comtdata_average1 = word_averaging_listn(model2,test_tokenized)
fname='C:/Users/Shivang/Desktop/Twitter airline/skg_dataset.csv'
np.savetxt(fname,X_comtdata_average1, delimiter=',', fmt='%f')
