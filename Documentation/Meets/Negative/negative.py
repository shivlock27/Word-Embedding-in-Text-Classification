...
dfpos=df[df.airline_sentiment=="negative"]
in1=dfpos.index
# print(in1)
dfneg=df[df.airline_sentiment!="negative"]
in0=dfneg.index
# print(in0)
...
#     x[0:2,0]=civpb[i,0:2]
#     x[0:2,1]=civpb[i,2:4]
#     pyplot.boxplot(x,labels=['Not Negative','Negative'])
#     pyplot.grid(True)
#     pyplot.xlabel('Metrics')
#     pyplot.ylabel('95%CI')
#     fna='C:/Users/Shivang/Desktop/Twitter airline/Negative/'+str(i)+".png"
#     pyplot.savefig(fna)
#     pyplot.close()
